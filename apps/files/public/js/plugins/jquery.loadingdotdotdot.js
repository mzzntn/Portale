(function($) {
    ...
    $.Loadingdotdotdot = function(el, options) {
        ...
        base.init = function() {
            ...
            base.$el.html("<span>"+text+"<em></em></span>");
            ...
            base.$loadingText.css({
                "position": "absolute",
                "top": (base.$el.outerHeight(false) / 2) - (base.$loadingText.outerHeight(false) / 2),
                "left": (base.$el.width(false) / 2) - (base.$loadingText.width() / 2)
            });
