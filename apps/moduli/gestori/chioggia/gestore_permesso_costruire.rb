...
module Moduli
	...
	class GestorePermessoCostruire
		...
		def self.controlla_dati_modulo(dati_post)
			...
			errori << Moduli::Funzioni.controlla_checkbox_obbligatorio(dati_post[:regolarita_urbanistica][:tipo_interv_urban], 'tipo_interv_urban', 'Selezionare una opzione.')
			...
			errori << Moduli::Funzioni.controlla_checkbox_obbligatorio(dati_post[:rispetto_sicurezza][:tipi_sicurezza], 'tipi_sicurezza', 'Selezionare una opzione.')
			#ASSEVERAZIONE
			...
			errori << Moduli::Funzioni.controlla_checkbox_obbligatorio(dati_post[:tab_strum_urban][:check_zone_vincoli], 'check_zone_vincoli', 'Selezionare una opzione.')
			...
			errori << Moduli::Funzioni.controlla_checkbox_obbligatorio(dati_post[:sicu_impianti][:scelta_soggetto_obbligo], 'scelta_soggetto_obbligo', 'Selezionare una opzione.')
			...
			errori << Moduli::Funzioni.controlla_checkbox_obbligatorio(dati_post[:consumi_energ][:tipo_consumi_energ_rin], 'tipo_consumi_energ_rin', 'Selezionare una opzione.')
			...
			errori << Moduli::Funzioni.controlla_checkbox_obbligatorio(dati_post[:int_strutt][:tipo_int_strutture], 'tipo_int_strutture', 'Selezionare una opzione.')
			errori << Moduli::Funzioni.controlla_checkbox_obbligatorio(dati_post[:int_strutt][:tipo_den_36], 'tipo_den_36', 'Selezionare una opzione.')
			errori << Moduli::Funzioni.controlla_checkbox_obbligatorio(dati_post[:aut_paesag][:tipo_aut_paesag], 'tipo_aut_paesag', 'Selezionare una opzione.')
			...
			errori << Moduli::Funzioni.controlla_checkbox_obbligatorio(dati_post[:vinc_idraulico][:tipo_vinc_idraulico_12], 'tipo_vinc_idraulico_12', 'Selezionare una opzione.')
			errori << Moduli::Funzioni.controlla_checkbox_obbligatorio(dati_post[:vinc_idraulico][:vinc_idraulico_3_13], 'vinc_idraulico_3_13', 'Selezionare una opzione.')
			errori << Moduli::Funzioni.controlla_checkbox_obbligatorio(dati_post[:natura][:tipo_natura_12], 'tipo_natura_12', 'Selezionare una opzione.')
