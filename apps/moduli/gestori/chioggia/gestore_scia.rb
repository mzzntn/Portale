...
module Moduli
	...
	class GestoreScia
		...
		def self.controlla_dati_modulo(dati_post)
			...
			errori << Moduli::Funzioni.controlla_checkbox_obbligatorio(dati_post[:pres_segnal][:tipo_pres_segnal], 'tipo_pres_segnal', 'Selezionare una opzione.')
			errori << Moduli::Funzioni.controlla_checkbox_obbligatorio(dati_post[:qual_interv][:tipo_qual_interv_c14], 'tipo_qual_interv_c14', 'Selezionare una opzione.')
			errori << Moduli::Funzioni.controlla_checkbox_obbligatorio(dati_post[:qual_interv][:tipo_qual_interv_c57], 'tipo_qual_interv_c57', 'Selezionare una opzione.')
			...
			errori << Moduli::Funzioni.controlla_checkbox_obbligatorio(dati_post[:reg_urban][:tipo_reg_urban], 'tipo_reg_urban', 'Selezionare una opzione.')
