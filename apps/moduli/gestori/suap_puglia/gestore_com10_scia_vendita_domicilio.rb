...
module Moduli
	...
	class GestoreCom10SciaVenditaDomicilio
		...
		def self.set_scene_widget(scene, hash_dati=nil)
			scene.id_modulo_com = '10'
			scene.nome_modulo = 'Forme speciali di vendita al dettaglio - VENDITA PRESSO IL DOMICILIO DEI CONSUMATORI'
