...
module Moduli
	...
	class GestoreCom4DomandaCentriCommercialiAutorizzate
		...
		def self.set_scene_widget(scene, hash_dati=nil)
			scene.id_modulo_com = '4'
			scene.nome_modulo = 'Centri commerciali, aree commerciali integrate e struttura isolata.'
