...
function displayCalendar(inputField,format,buttonObj,displayTime,timeInput,additionalParams)
{
  if (additionalParams['pathToImages']) pathToImages = additionalParams['pathToImages'];
