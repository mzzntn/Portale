...
if (defined('URL_APP_APPUNTAMENTI') && $IMP->security->checkAdmin()){
        ?>
        &nbsp;|&nbsp;<a href="<?=URL_APP_APPUNTAMENTI?>/amministrazione/elenco_richieste.php" target='_blank'>Gestione appuntamenti</a>
<?php
}
