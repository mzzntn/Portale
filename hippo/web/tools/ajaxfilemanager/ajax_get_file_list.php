...
// echo '<script type="text/javascript">console.log("PATH_WEBDATA '.PATH_WEBDATA.' URL_WEBDATA '.URL_WEBDATA.'")</script>';
// $value = "/var/www/test/civilianext/hippo/web/data/files/test.pdf";
// $output = '';
...
// $value = str_replace(PATH_WEBDATA, URL_WEBDATA, $value);
// 
// 
...
// 	$output = $value;
// }
// if (defined('SERVER')) $server = SERVER;
// else $server = $_SERVER['HTTP_HOST'];
// return "http://" .  addTrailingSlash($server) . removeBeginingSlash($output);
...
<tr class="even" id="topRow" onclick="setDocInfo('folder', '0');">
						...
						<?php
							...
							{
// 								echo '<script type="text/javascript">console.log("file details in filelist '.str_replace("\n","",print_r($file,true)).'")</script>';
								...
								?>
								<tr class="<?php echo $css; ?>" id="row<?php echo $count; ?>"  onclick="setDocInfo('<?php echo $file['type']; ?>', '<?php echo $count; ?>');">
									<td ><input type="checkbox" name="check[]" id="check<?php echo $count; ?>" value="<?php echo $file['name']; ?>" <?php echo $strDisabled; ?> />
									...
									<td><a href="<?php echo getFileUrl($file['path']); ?>" target="_blank"><span class="<?php echo $file['cssClass']; ?>"><span id="flag<?php echo $count; ?>" class="<?php echo $file['flag']; ?>">&nbsp;</span></span></a></td>
								...
								{
									?>
									<tr class="<?php echo $css; ?>" id="row<?php echo $count; ?>" onclick="setDocInfo('folder', '<?php echo $count; ?>');">
										<td ><input type="checkbox" name="check[]" id="check<?php echo $count; ?>" value="<?php echo $file['name']; ?>" <?php echo $strDisabled; ?>/>
