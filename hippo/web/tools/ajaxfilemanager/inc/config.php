<?php
// KLUDGE shutdown d'emergenza per uso non autorizzato (al di fuori del pannello di amministrazione)

    //include_once(dirname(__FILE__).'/../../../init.php');
    include_once(base64_decode($_GET["c"])."/../init.php"); // passo il path di installazione codificato in base64 per renderlo un po' meno vis    ibile
