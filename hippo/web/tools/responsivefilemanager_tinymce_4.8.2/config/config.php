...
if(!isset($_GET["c"])) {die();}
include_once(base64_decode($_GET["c"]).'/init.php');
if (!$IMP->security->checkAdmin()) {
...
setlocale(LC_CTYPE, 'it_IT'); //correct transliteration
...
// 	'base_url' => ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == "on") ? "https" : "http"). "://". @$_SERVER['HTTP_HOST'],
	...
	*/
// 	'upload_dir' => "/source/",
	'upload_dir' => HOME."/data/",
	'upload_dir_path' => PATH_WEBDATA."/",
	/*
	|--------------------------------------------------------------------------
	...
	*/
// 	'current_path' => '../source/',
    'current_path' => PATH_WEBDATA."/",
    'current_url' => URL_WEBDATA."/",
...
// 	'thumbs_base_path' => '../thumbs/',
    'thumbs_base_path' => HOMEPATH."/thumbs/",
    'thumbs_base_url' => HOME."/thumbs/",
	...
	*/
	...
	'ext_file'                                => array( 'doc', 'docx', 'rtf', 'pdf', 'xls', 'xlsx', 'txt', 'csv', 'html', 'xhtml', 'psd', 'sql', 'log', 'fla', 'xml', 'ade', 'adp', 'mdb', 'accdb', 'ppt', 'pptx', 'odt', 'ots', 'ott', 'odb', 'odg', 'otp', 'otg', 'odf', 'ods', 'odp', 'css', 'ai', 'kmz','dwg', 'dxf', 'hpgl', 'plt', 'spl', 'step', 'stp', 'iges', 'igs', 'sat', 'cgm', 'tiff','p7m', 'm7m', ''), //Files
	...
	*******************/
	...
	'hidden_folders'                          => array(".svn","documenti"),
