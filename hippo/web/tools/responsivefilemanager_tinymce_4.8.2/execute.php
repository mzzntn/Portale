	...
	switch($_GET['action'])
	{
		...
		case 'create_file':
			...
			if($ftp){
                ...
                file_put_contents("/var/svn/hippo/php5/web/tools/responsivefilemanager_tinymce_4.8.2/debug.log","doing a file put contents to ".$path.$name."\n",FILE_APPEND);
		...
		case 'save_text_file':
			...
			if($ftp){
                ...
                file_put_contents("/var/svn/hippo/php5/web/tools/responsivefilemanager_tinymce_4.8.2/debug.log","doing a file put contents to $path\n",FILE_APPEND);
